...
<%
    ...
    try {
       ...
       lista = conDAO.listarContratosAdquiridosObjCharts();
           
        } catch (Exception e) {
            out.print("Não foi possivel atender a solicitação");
        }
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                               <% 
                                                ...
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Ganhos Totais</div>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Contratos adquiridos pelos os clientes</h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
