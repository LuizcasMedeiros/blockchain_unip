                                        ...
                                        <table class="table table-striped table-dark" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">CPF DO CONTRATANTE</th>
                                                    <th scope="col">NOME DO CONTRATANTE</th>
                                                    <th scope="col">VALOR DO CONTRATO DURANTE O PERIODO DE VIGENCIA</th>
                                                    <th scope="col">APROVADO E ASSINADO PELO O GERENTE</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row"><%=con.getId()%></th>
                                                    <td> <%=con.getDataInclusao()%></td>
                                                    <td> <%=con.getDataEncerramento()%></td>
                                                    <td> <%=con.getDescricao()%></td>
                                                    <td> <%=con.getCliente().getCpf()%></td> 
                                                    <td> <%=con.getCliente().getNome()%></td>
                                                    <td> <%=con.getValor()%></td>
                                                    <td> <%=con.getFuncionario().getNome()%></td>
                                                </tr>
