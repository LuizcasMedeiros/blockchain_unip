                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Listar Criptoativos <span><a href="incluir_criptoativos_funcionario.jsp" class="btn btn-primary mt-2 mb-2">Novo Criptoativo</a> </span></h6>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" href="logoff_funcionario.jsp.jsp">Sair</a>
                        </div>
                    </div>
                </div>
            </div>
